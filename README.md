...
STOP LOSS to mage risk in efficient way while using predicted orderbook can be done in 3 way 
      ...
      •	If you want to take the high risk in case of very volatile asset, SL with the sum of two price upper your order price in case of 
        sell or two level price lower plus AOPV
